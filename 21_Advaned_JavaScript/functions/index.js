...
console.log(greetFunction("Bhavishaya"));
...
console.log("\nCallBack Function goes from here :- ");
// Callback function :- 
...
//* function to be used as a callback function 
function greetUser(name) {
    console.log(`Hello! ${name}`);
}

processUserInput("Bhavishaya", greetUser);
...
console.log(mathOperation(5, 2, mod));
//* So here mathOperation() is a higher order function and add(), sub(), mul(), div(), mod() are the callback functions 
